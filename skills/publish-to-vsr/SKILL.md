...
- The repository path is: `/home/viniciusrocha/projetos-pessoais/vsr-skills`
- Remote: `git@github.com:vsanrocha/vsr-skills.git`
...
```bash
cd /home/viniciusrocha/projetos-pessoais/vsr-skills && bun run build
```
...
```bash
cd /home/viniciusrocha/projetos-pessoais/vsr-skills && bun run validate
```
...
```bash
cd /home/viniciusrocha/projetos-pessoais/vsr-skills
